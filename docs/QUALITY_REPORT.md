...
本报告记录 2026-09-17 完成的本地可重复质量门禁。

## 验证环境

- 操作系统：Windows；
- MoonBit：`moon 0.1.20260915 (2e1a46d 2026-09-15)`；
- 核心目标：Wasm、JavaScript、Native；
...
moon coverage analyze -p moonmqtt/moonmqtt -- -f summary
...
| Wasm 严格检查/测试 | 通过，24/24 |
| JavaScript 严格检查/测试 | 通过，24/24 |
| Native 严格检查/测试 | 通过，25/25 |
